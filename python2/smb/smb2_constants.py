...
# Values for CompletionFilter field in SMB2ChangeNotifyRequest class
# The values are defined in [MS-SMB2]: 2.2.35
...
FILE_NOTIFY_CHANGE_EA = 0x080
FILE_NOTIFY_CHANGE_SECURITY = 0x100
FILE_NOTIFY_CHANGE_STREAM_NAME = 0x200
FILE_NOTIFY_CHANGE_STREAM_SIZE = 0x400
FILE_NOTIFY_CHANGE_STREAM_WRITE = 0x800

# Action values defined in [MS-FSCC]: 2.4.42
FILE_NOTIFY_INFORMATION_NAMES = {
    0x1: 'FILE_ACTION_ADDED',
    0x2: 'FILE_ACTION_REMOVED',
    0x3: 'FILE_ACTION_MODIFIED',
    0x4: 'FILE_ACTION_RENAMED_OLD_NAME',
    0x5: 'FILE_ACTION_RENAMED_NEW_NAME',
    0x6: 'FILE_ACTION_ADDED_STREAM',
    0x7: 'FILE_ACTION_REMOVED_STREAM',
    0x8: 'FILE_ACTION_MODIFIED_STREAM',
    0x9: 'FILE_ACTION_REMOVED_BY_DELETE'
}
